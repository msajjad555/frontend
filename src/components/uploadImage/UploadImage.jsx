...
const UploadImage = () => {
  const [image, setImage] = useState({
    name:"", category:"", price:"", discription:"", file:""
  })
  const handleInput=(e)=>{
        ...
        <div className="row">
          ...
          <div className="col-lg-6"><div className="d-flex flex-row align-items-center mb-4">
                  ...
                  <div className="d-flex flex-row align-items-center mb-4">
                    ...
                    <div className="form-outline flex-fill mb-0">
                    <label className="form-label capital" htmlFor="form3Example3c" >CATEGORY</label>
          ...
          <div className="col-6">
            <div className="d-flex flex-row align-items-center mb-4">
                  ...
                  <div className="d-flex" style={{height: "2px",background:"lime", marginBottom:"25px"}}>
...
<div className="col-12">
                  <div className="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                    <button type="button" className="btn btn-primary btn-lg text-center capital"onClick={postData} style={{background:"purple"}}>submit</button>
                  </div>
                  </div>
